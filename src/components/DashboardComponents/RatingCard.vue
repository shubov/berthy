<!-----------------------------------------------------------------------------
  ...
  - The code in RatingCard.vue is proprietary and confidential.               -
...
<template>
    <v-container>
        <v-card-subtitle class="text-center py-0">Rating</v-card-subtitle>
...
<script>
    ...
    export default {
        name: "RatingCard",
        props: ['getTotalRating', 'getRatingTrend'],
        data: function () {
            return {
                icons: {
